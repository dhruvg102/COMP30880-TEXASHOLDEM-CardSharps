...
//enumerators for handvalue, riskvalue and cardvalue
enum CardValue{
    ACE(1, true),
    DEUCE(2, false),
    THREE(3, false),
...
public class HoldemHand {
    ...
    public boolean isStraight() { //returns true if all cards in the hand form a straight (values not suit)
        sortHand();
    ...
    //Sorting/catergorize the hand will probably be needed for hand classification to simplify going through each hand - I dont think TODO
    //sort hand -> pokerhand
    //categorize hand -> pokerhand
